...
my $cmd1= "/bin/bash /root/eppclient_prod_client/eppclient/replay_tool/ote_script/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc1000.xml";
