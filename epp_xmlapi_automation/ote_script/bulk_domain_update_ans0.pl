...
<domain:add><domain:ns><domain:hostObj>ans0.qaregistry.qa</domain:hostObj><domain:hostObj>ans1.qaregistry.qa</domain:hostObj></domain:ns><domain:contact type="admin">QDR123</domain:contact><domain:contact type="tech">QDR123</domain:contact></domain:add>
<domain:rem><domain:ns><domain:hostObj>ns1.bluehost.com</domain:hostObj><domain:hostObj>ns2.bluehost.com</domain:hostObj></domain:ns><domain:contact type="admin">OOR00304</domain:contact><domain:contact type="tech">OOR00304</domain:contact><domain:contact type="billing">OOR00304</domain:contact></domain:rem>
<domain:chg><domain:registrant>QDR123</domain:registrant></domain:chg>
</domain:update>
</update>
