...
my $cmd1 = "/bin/perl $FILEPATH/p2.pl";`$cmd1`;
...
my $_;
open my $A, '<', '$FILEPATH/dc5000.xml' or die $!;open my $B, '<', '$FILEPATH/dc5001.xml' or die $!;open my $C, '<', '$FILEPATH/dc5002.xml' or die $!;open my $D, '<', '$FILEPATH/dc5003.xml' or die $!;open my $E, '<', '$FILEPATH/domains.txt' or die $!;
