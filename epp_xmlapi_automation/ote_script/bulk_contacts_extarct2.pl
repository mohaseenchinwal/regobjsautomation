...
my $cmd7= "/bin/rm -rf /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5000.xml";
my $cmd8= "/bin/rm -rf /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5001.xml";
my $cmd9= "/bin/rm -rf /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5002.xml";
my $cmd10= "/bin/rm -rf /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5003.xml";
...
my $cmd5="/bin/perl /root/eppclient_prod_client/eppclient/replay_tool/ote_script/bulk_contacts_extarct1.pl > /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc3000.xml";
`$cmd5`;


#process the contactinfo file for xml parsing

my $cmd1= "/bin/bash /root/eppclient_prod_client/eppclient/replay_tool/ote_script/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc4000.xml";
my $cmd4= "/bin/bash /root/eppclient_prod_client/eppclient/replay_tool/ote_script/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc4001.xml";
my $cmd11= "/bin/bash /root/eppclient_prod_client/eppclient/replay_tool/ote_script/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc4002.xml";
my $cmd6= "/bin/bash /root/eppclient_prod_client/eppclient/replay_tool/ote_script/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc4003.xml";
my $cmd2= "/bin/grep -i addr";
my $cmd3 = "/bin/sed \'s/<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>//g\'";
my $path1="/root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5000.xml";
my $path2="/root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5001.xml";
my $path3="/root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5002.xml";
my $path4="/root/eppclient_prod_client/eppclient/replay_tool/ote_script/dc5003.xml";
...
{$techcontactval="AB40072";$sth->execute($domainname, $regname, $admincontactval, $techcontactval, $billingcontactval)}
elsif($admincontact eq "billing" && $billingcontact eq "tech") #no admin contact
{$techcontactval="AB40072";$sth->execute($domainname, $regname, $techcontactval, $admincontactval, $billingcontactval)}
else {}}
else {$onlytechcontact=$config->{response}->{resData}->{"domain:infData"}->{"domain:contact"}->{type};$onlytechcontactval=$config->{response}->{resData}->{"domain:infData"}->{"domain:contact"}->{content};$billingcontactval="AB40072";$techcontactval="AB40072";$sth->execute($domainname, $regname, $techcontactval, $billingcontactval, $onlytechcontactval)}}
close $handle;
