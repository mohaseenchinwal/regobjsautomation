...
#<domain:name>jbhschool.sch.qa</domain:name>
#<domain:add><domain:ns><domain:hostObj>ns1.bluehost.com</domain:hostObj><domain:hostObj>ns2.bluehost.com</domain:hostObj></domain:ns><domain:contact type="admin">OOR00304</domain:contact><domain:contact type="tech">OOR00304</domain:contact></domain:add>
#<domain:rem><domain:contact type="admin">QDR123</domain:contact><domain:contact type="tech">QDR123</domain:contact></domain:rem>
...
system("/bin/bash /root/eppclient_ote_clinet/replay_tool/run.sh Replay < /root/eppclient_ote_clinet/replay_tool/dc1000.xml");


#open(FH, '>', 'dc2000.xml') or die "cannot open file";
#select FH;
