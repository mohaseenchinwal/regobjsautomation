...
<domain:name>mascus.com.qa</domain:name>
</domain:info>
</info>
...
`bash /root/eppclient_prod_client/eppclient/replay_tool/run.sh Replay < /root/eppclient_prod_client/eppclient/replay_tool/dc1000.xml | /bin/grep ok  >> test.txt`;
}
