...
my $cmd10 = "/bin/perl /root/eppclient_prod_client/eppclient/replay_tool/bulk_expiry_info.pl > /root/eppclient_prod_client/eppclient/replay_tool/exp_out.txt"
